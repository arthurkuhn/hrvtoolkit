function [ qrs_amp_raw,qrs_i_raw ] = kotaFunction2( sig, fs, gr )
%KOTAFUNCTION2 Summary of this function goes here
...
% Not sure why we're getting NaN's but probably should investigate
sig(isnan(sig)) = 0;
